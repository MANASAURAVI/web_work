...
export const PROJECTS: Project[] = [
  {
    ...
    shortDescription: "Official digital news & media portal for 30,000+ university students, hosting daily articles, live TV broadcasts, podcasts, and student journalism.",
  ...
  },
  {
    ...
    shortDescription: "Cybersecurity conference and hackathon platform managing registrations, team submissions, live event schedules, and competition leaderboards.",
  ...
  },
  {
    ...
    shortDescription: "High-octane combat sports brand & event web app with fight night countdowns, athlete rosters, and dynamic fighter application forms.",
  ...
  },
  {
    ...
    badge: "Interactive Conference",
    shortDescription: "Interactive cybersecurity conference hub with a command-center dashboard, live CTF challenges, speaker submissions, and real-time mountain telemetry.",
  ...
  },
  {
    ...
    shortDescription: "Comprehensive event & workshop management web app featuring live schedule tracking, speaker lineup, sponsor portals, and instant registration.",
